...
export default function SmoothScrollParalax() {
  return (
...
const ParallaxImages = () => {
  return (
    <div className="mx-auto z-10  max-w-5xl px-4 pt-[200px] relative ">
      <ParallaxImg
...
const ParallaxImg = ({ className, src, alt, start, end }) => {
  const ref = useRef(null);
  const { scrollYProgress } = useScroll({
    target: ref,
    offset: [`${start}px end `, `${end}px start`],
  });
